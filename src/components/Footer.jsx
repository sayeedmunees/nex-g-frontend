...
const Footer = () => {
  return (
    <footer className="bg-luxury-green text-white pt-12 pb-8 mt-16">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 text-sm text-dark-gray bg-white border border-luxury-gold/30 rounded focus:outline-none focus:border-luxury-gold"
              />
              <button className="bg-luxury-gold text-white px-6 py-2 text-sm hover:bg-luxury-gold/90 transition-colors duration-300 rounded whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-white/60 text-sm text-center md:text-right">
              &copy; 2024 NEX-G Luxury Fashion. All rights reserved.
            </div>
          </div>
        </div>
      </div>
